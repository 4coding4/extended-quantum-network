...
def network_setup(length=0, process_positions: int = 3) -> Network:
    """
...
def plot_fidelity(csv_file: str, plot_file: str = "fidelity-over-length.png"):
    """
    Plot the fidelity of entanglement over the distance of the quantum channel.
    :param csv_file: The CSV file containing the fidelity values
    :param plot_file: The name of the plot file
    """
    # Plot the results
...
def main(verbose: bool = False, csv_file: str = "data.csv", plot_file: str = "fidelity-over-length.png"):
    """
    ...
    for length in lengths:
        ...
        for i in range(num_each_sim):
            ...
            protocol_alice = EntangleNodes(on_node=qnetwork.subcomponents["Alice"], is_source=True,
                                           name="ProtocolAlice")
    ...
    f.close()
    plot_fidelity(csv_file, plot_file)
