...
def network_setup() -> Network:
    ...
    # Add a component that generates Qbits. The qbits generated by the component share a specified quantum state. The
    # generated qbits have state b00, this means `|00> + |11>`. Moreover, the source will distribute the generated qbits
    ...
    # at a time.
    alice.add_subcomponent(
        QSource("QuantumSourceAlice", state_sampler=StateSampler([ketstates.b00]),
                num_ports=2, status=SourceStatus.EXTERNAL,
                models={"emission_delay_model": FixedDelayModel(delay=5)})
    )
...
if __name__ == '__main__':
    ...
    # Compute the fidelity between the qbits quantum state and the reference state (`|00> + |11>`)
